...
const handler_1 = require("../app/handler");
...
describe('FindOne [GET]', () => {
    it('success', () => {
        try {
            const s = sinon_1.default
                .mock(books_1.books);
            s.expects('findOne')
                .atLeast(1)
                .atMost(3)
                .resolves(booksMock.findOne);
            return lambda_tester_1.default(handler_1.findOne)
...
describe('Find [GET]', () => {
    it('success', () => {
        ...
        return lambda_tester_1.default(handler_1.find)
            .event({})
            .expectResult((result) => {
            chai_1.expect(result.statusCode).to.equal(200);
            const body = JSON.parse(result.body);
...
describe('Create [POST]', () => {
    it('success', () => {
        ...
        return lambda_tester_1.default(handler_1.create)
...
describe('Update [PUT]', () => {
    it('success', () => {
        ...
        return lambda_tester_1.default(handler_1.update)
...
describe('DeleteOne [Delete]', () => {
    it('success', () => {
        ...
        return lambda_tester_1.default(handler_1.deleteOne)
